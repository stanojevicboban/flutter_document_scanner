...
/// An implementation of [TraitDocumentScannerPlatform]
/// that uses method channels.
class MethodChannelTraitDocumentScanner extends TraitDocumentScannerPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('trait_document_scanner');
