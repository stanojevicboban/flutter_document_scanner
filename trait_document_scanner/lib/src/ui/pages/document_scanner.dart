...
import 'package:trait_document_scanner/src/bloc/app/app_bloc.dart';
import 'package:trait_document_scanner/src/bloc/app/app_state.dart';
import 'package:trait_document_scanner/src/document_scanner_controller.dart';
import 'package:trait_document_scanner/src/ui/pages/crop_photo_document_page.dart';
import 'package:trait_document_scanner/src/ui/pages/edit_document_photo_page.dart';
import 'package:trait_document_scanner/src/ui/pages/take_photo_document_page.dart';
import 'package:trait_document_scanner/src/utils/crop_photo_document_style.dart';
import 'package:trait_document_scanner/src/utils/dialogs.dart';
import 'package:trait_document_scanner/src/utils/edit_photo_document_style.dart';
import 'package:trait_document_scanner/src/utils/general_styles.dart';
import 'package:trait_document_scanner/src/utils/model_utils.dart';
import 'package:trait_document_scanner/src/utils/take_photo_document_style.dart';

/// This class is the main page of the application
class TraitDocumentScanner extends StatelessWidget {
  /// Create a main page with properties and methods
  /// to manage the document scanner.
  const TraitDocumentScanner({
    super.key,
    this.controller,
