...
class MockTraitDocumentScannerPlatform extends Mock
    with MockPlatformInterfaceMixin
    implements TraitDocumentScannerPlatform {}

void main() {
  TestWidgetsFlutterBinding.ensureInitialized();

  group('TraitDocumentScanner', () {
    late TraitDocumentScannerPlatform flutterDocumentScannerPlatform;

    setUp(() {
      flutterDocumentScannerPlatform = MockTraitDocumentScannerPlatform();
