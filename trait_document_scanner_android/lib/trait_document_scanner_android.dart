...
/// The Android implementation of [TraitDocumentScannerPlatform].
class TraitDocumentScannerAndroid extends TraitDocumentScannerPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('trait_document_scanner_android');

  /// Registers this class as the default instance
  /// of [TraitDocumentScannerPlatform]
  static void registerWith() {
    TraitDocumentScannerPlatform.instance = TraitDocumentScannerAndroid();
  }
