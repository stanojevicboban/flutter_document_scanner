package com.christian.traitDocumentScanner
...
class TraitDocumentScannerPlugin : FlutterPlugin, MethodCallHandler {
    ...
    companion object {
        ...
        const val PLUGIN_ID = "trait_document_scanner_android"
    }
        ...
        when (call.method) {
            "findContourPhoto" -> {
                try {
                    ...
                    result.error("TraitDocumentScanner-Error", "Android: " + e.message, e)
                }
            }
